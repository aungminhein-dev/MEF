<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0"><a href="#"
        ...
        <div class="btn-group ms-2 ms-lg-3"><button type="button"
                class="btn btn-sm btn-outline-gray-600">Share</button>
            ...
            <div class="btn-group">
                <div class="dropdown me-1"><button
                    ...
                    <div class="dropdown-menu dropdown-menu-end pb-0"><span
                            class="small ps-3 fw-bold text-dark">Show</span>
                        <a class="dropdown-item d-flex align-items-center fw-bold" href="#">10 <svg
                            ...
                            class="dropdown-item fw-bold rounded-bottom" href="#">30</a>
                    </div>
                </div>
    ...
    <table class="table user-table table-hover align-items-center">
        ...
        <tbody>
                ...
                <td><a href="#" class="d-flex align-items-center"><img
                        ...
                        <div class="d-block"><span class="fw-bold">Roy Fendley</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="aec7c0c8c1eecbd6cfc3dec2cb80cdc1c3">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
            ...
            <tr>
                ...
                <td><a href="#" class="d-flex align-items-center">
                        ...
                        <div class="d-block"><span class="fw-bold">Scott Anderson</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="e1888f878ea18499808c918d84cf828e8c">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
                <td><span class="fw-normal">10 Feb 2020</span></td>
            ...
            <tr>
                ...
                <td><a href="#" class="d-flex align-items-center"><img
                        ...
                        <div class="d-block"><span class="fw-bold">George Driskell</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="a7cec9c1c8e7c2dfc6cad7cbc289c4c8ca">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
                <td><span class="fw-normal">10 Feb 2020</span></td>
            ...
            <tr>
                ...
                <td><a href="#" class="d-flex align-items-center"><img
                        ...
                        <div class="d-block"><span class="fw-bold">Bonnie Green</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="d4bdbab2bb94b1acb5b9a4b8b1fab7bbb9">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
                <td><span class="fw-normal">10 Feb 2020</span></td>
            ...
            <tr>
                <td>
                    <div class="form-check dashboard-check"><input class="form-check-input" type="checkbox" value
                            id="userCheck5"> <label class="form-check-label" for="userCheck5"></label></div>
                </td>
                <td><a href="#" class="d-flex align-items-center"><img
                        ...
                        <div class="d-block"><span class="fw-bold">Ronnie Buchanan</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="422b2c242d02273a232f322e276c212d2f">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
                <td><span class="fw-normal">10 Feb 2020</span></td>
            ...
            <tr>
                <td>
                    <div class="form-check dashboard-check"><input class="form-check-input" type="checkbox" value
                            id="userCheck6"> <label class="form-check-label" for="userCheck6"></label></div>
                </td>
                <td><a href="#" class="d-flex align-items-center">
                        <div
                            class="avatar d-flex align-items-center justify-content-center fw-bold rounded bg-secondary me-3">
                        ...
                        <div class="d-block"><span class="fw-bold">Jane Rinehart</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="51383f373e113429303c213d347f323e3c">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
                <td><span class="fw-normal">10 Feb 2020</span></td>
            ...
            <tr>
                <td>
                    <div class="form-check dashboard-check"><input class="form-check-input" type="checkbox" value
                            id="userCheck7"> <label class="form-check-label" for="userCheck7"></label></div>
                </td>
                <td><a href="#" class="d-flex align-items-center"><img
                        ...
                        <div class="d-block"><span class="fw-bold">William Ginther</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="abc2c5cdc4ebced3cac6dbc7ce85c8c4c6">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
                <td><span class="fw-normal">10 Feb 2020</span></td>
            ...
            <tr>
                <td>
                    <div class="form-check dashboard-check"><input class="form-check-input" type="checkbox" value
                            id="userCheck8"> <label class="form-check-label" for="userCheck8"></label></div>
                </td>
                <td><a href="#" class="d-flex align-items-center"><img
                        ...
                        <div class="d-block"><span class="fw-bold">Margaret Dow</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="b7ded9d1d8f7d2cfd6dac7dbd299d4d8da">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
                <td><span class="fw-normal">10 Feb 2020</span></td>
            ...
            <tr>
                <td class="border-0">
                    <div class="form-check dashboard-check"><input class="form-check-input" type="checkbox" value
                            id="userCheck9"> <label class="form-check-label" for="userCheck9"></label></div>
                </td>
                <td class="border-0"><a href="#" class="d-flex align-items-center">
                        ...
                        <div class="d-block"><span class="fw-bold">Michael Hopkins</span>
                            <div class="small text-gray"><span class="__cf_email__"
                                    data-cfemail="3950575f56795c41585449555c175a5654">[email&#160;protected]</span>
                            </div>
                        </div>
                    </a></td>
